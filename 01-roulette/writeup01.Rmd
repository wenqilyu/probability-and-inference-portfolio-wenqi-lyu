...
the mean number of plays is `r mean(num.plays)` , they are estimated play `r mean(num.plays)` times either win $300 or lose $200.
...
1.the conclusion might be biased if we do not simulate a large amount of people participant in the roulette.2.The Martingale strategy appears to always end in positive earnings, regardless of how unlucky a string of spins may be. the best case scenario is that we have 10 number of plays, the average earning is estimated 0, in the other case, the walk out money always negative.
