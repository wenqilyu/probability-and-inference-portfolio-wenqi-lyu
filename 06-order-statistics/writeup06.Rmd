...
hist(samp,freq = FALSE,add = TRUE,breaks = 100)
```
...
p <- ppoints(200)
xmin <- p
ymin <- porder2(p,k=1, n=200,dist = "gamma",shape=2)
plot(xmin,ymin,type = "l")

xmin1 <- p
ymin1 <- dorder2(p,k=1, n=200,dist = "gamma",shape=2)
plot(xmin1,ymin1,type = "l")
```
