...
* this step gives us the correlation in different sample size and different power.
...
* this plot shows the relationship between the correlation and power in different sample size. When the sample size increase, the power increase in the same correlation. In addition, the correlation will increase in the same power and the sample size decrease.
